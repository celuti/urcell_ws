...
: ${AMENT_CURRENT_PREFIX:="/home/user/ws/urcell_ws/install/urcell_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urcell_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urcell_description/environment/path.sh"
