...
static const _PartsTargetsPos_Request_type_support_symbol_names_t _PartsTargetsPos_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_services, srv, PartsTargetsPos_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_services, srv, PartsTargetsPos_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_services, srv, PartsTargetsPos_Request)() {
  return &::opencv_services::srv::rosidl_typesupport_c::PartsTargetsPos_Request_message_type_support_handle;
}
...
static const _PartsTargetsPos_Response_type_support_symbol_names_t _PartsTargetsPos_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_services, srv, PartsTargetsPos_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_services, srv, PartsTargetsPos_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_services, srv, PartsTargetsPos_Response)() {
  return &::opencv_services::srv::rosidl_typesupport_c::PartsTargetsPos_Response_message_type_support_handle;
}
...
static const _PartsTargetsPos_type_support_symbol_names_t _PartsTargetsPos_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_services, srv, PartsTargetsPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_services, srv, PartsTargetsPos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, opencv_services, srv, PartsTargetsPos)() {
  return &::opencv_services::srv::rosidl_typesupport_c::PartsTargetsPos_service_type_support_handle;
}
